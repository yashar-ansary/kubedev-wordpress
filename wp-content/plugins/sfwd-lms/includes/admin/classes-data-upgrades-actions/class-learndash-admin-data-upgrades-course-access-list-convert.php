			...
			<tr id="learndash-data-upgrades-container-<?php echo esc_attr( $this->data_slug ); ?>" class="learndash-data-upgrades-container">
				...
				<td class="learndash-data-upgrades-status-container">
					...
					printf(
						...
						esc_html_x( 'Convert %s Access Lists', 'placeholder: Course', 'learndash' ),
					...
					<?php
						printf(
							// translators: placeholder: course.
							esc_html_x( 'This convert the %s access list setting to user meta where it can be managed more efficiently. (Optional)', 'placeholder: course', 'learndash' ),
