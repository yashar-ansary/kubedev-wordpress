			...
			$this->setting_option_fields = array(
				...
				'has_archive'       => array(
					...
					'help_text'           => sprintf(
						...
						esc_html_x( 'Enables the front end archive page where all %1$s are listed. You must %2$s for the change to take effect.', 'placeholders: groups, link to WP Permalins page', 'learndash' ),
