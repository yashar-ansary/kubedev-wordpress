...
<?php if ( bbp_current_user_can_access_create_reply_form() ) : ?>
	...
	<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form <?php if ( bbp_is_single_topic() ) { echo esc_attr( 'bb-modal bb-modal-box' ); } ?>">
				...
				<div>
					...
					<?php if ( ! ( bbp_use_wp_editor() || current_user_can( 'unfiltered_html' ) ) ) : ?>
						...
						<p class="form-allowed-tags">
							<label><?php esc_html_e( 'You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes:', 'buddyboss-theme' ); ?></label><br />
