...
add_action( 'tgmpa_register', 'buddyboss_theme_register_required_plugins' );

function buddyboss_theme_register_required_plugins() {
  $plugins = array(

    array(
      'name'               => 'BuddyBoss Platform', // The plugin name.
      'slug'               => 'buddyboss-platform', // The plugin slug (typically the folder name).
      'source'             => 'https://dl.ariawp.com/themes/buddyboss/updates/buddyboss-platform.zip',
      'version'            => '1.7.4',
