	...
	<?php if ( $settings['switch_filter'] ) : ?>
        <div class="item-options">
			<?php foreach ( $groups_filter as $k => $gtype ) { ?>
                <a href="#" id="bb-<?php echo esc_attr( $k ); ?>-groups"
                   class="bb-groups__tab <?php echo $k == $type ? esc_attr( 'selected' ) : ''; ?>"
			...
			<?php else : ?>
                ...
                <div class="bb-groups-list bb-groups-list--<?php echo esc_attr( $k ); ?> bb-no-data bb-no-data--groups <?php echo $k == $type ? esc_attr( 'active' ) : ''; ?>">
                    ...
                    <a href="<?php echo trailingslashit( bp_get_groups_directory_permalink() . 'create' ); ?>"
                       class="bb-no-data__link"><?php echo esc_html__( 'Create a group', 'buddyboss-theme' ); ?></a>
                </div>
