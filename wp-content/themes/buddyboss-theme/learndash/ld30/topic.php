				...
				if ( ! empty( $buddyboss_content ) ) {
					...
					<div class="learndash_content_wrap">
						...
						if ( $show_content ) :
							...
							if ( function_exists( 'learndash_lesson_hasassignments' ) ) {
								$ld_has_lesson_assignment = learndash_lesson_hasassignments( $post );
							} else {
								$ld_has_lesson_assignment = lesson_hasassignments( $post );
							}
							if ( $ld_has_lesson_assignment && ! empty( $user_id ) ) :
