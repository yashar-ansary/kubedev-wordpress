...
<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'woocommerce-table__line-item order_item', $item, $order ) ); ?>">
	...
	<td class="woocommerce-table__product-total product-total" data-title="<?php esc_html_e( 'Total', 'buddyboss-theme' ); ?>">
...
<tr class="woocommerce-table__product-purchase-note product-purchase-note">
	...
	<td colspan="4" data-title="<?php esc_html_e( 'Notes', 'buddyboss-theme' ); ?>"><?php echo wpautop( do_shortcode( wp_kses_post( $purchase_note ) ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></td>
