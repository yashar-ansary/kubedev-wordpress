...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'yashar_ac3b52ebc92d50348408_20220619180458_archive.zip';
	const ARCHIVE_SIZE		 = '161344169';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ac3b52e-19180458';
    const SECONDARY_PACKAGE_HASH = 'e9878d4-19180458';
	const VERSION			 = '1.4.6';
